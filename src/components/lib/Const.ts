...
export const BUTTON_RESEND_LABEL = "Отправить"
...
export const MSG_NO_SECURITY = "Ваш браузер не позволяет выполнить данную функцию из соображений безопасности"
...
export const EVENT_KINDS: string[] = ["-","Сис-ма безопасности","Вызов для изменения",
                "Вызов для добавления","Добавление", "Изменение", "Удаление","Подготовка отчета",
                "Загрузка отчета", "Выполнение артефакта"]


export const FORM_ITEMS_LAYOUT: object = {
  labelCol: {
    xs: {
      span: 24,
    },
...
export const FORM_ITEMS_LAYOUT_FOR_PRINT: object = {
  labelCol: {
    xs: {
      span: 26,
    },
...
export const FORM_ITEMS_LAYOUT_WITHOUT_LABEL: object = {
  wrapperCol: {
    xs: {
      offset: 24,
      span: 24,
...
export const SQL_ACTIONS: string[] = ["-","Чтение","Вставка","Изменение","Удаление"];
