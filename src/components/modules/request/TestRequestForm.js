...
const TestRequestForm = (props) => {
    ...
    return <Form
        ...
        <Form.Item
            ...
            <DataSelect.CapClassSelect capClassType={204} 
                onChange={(val,disp)=>{props.form.setFieldsValue({"testRequestCapclassName":disp})}}                
                displayValue={props.initialValues["testRequestCapclassName"]} 
                style={{ width: "100%" }} />
        </Form.Item>
    </Form>
}
